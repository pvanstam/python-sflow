'''
    nawasmq - Module for NaWas messaging with MQ 
...
class PrefixMessage(_Message):
    ...
    def __init__(self, asn="", prefix="", nexthop="", announce=True):
    ...
    def set_message(self, asn="", prefix="", nexthop="", announce=True):
...
'''
    nawasmq listener and send classes and functions
'''
